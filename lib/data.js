...
export const services = [
  ...
  },
  {
    ...
    desc: "Leading cross-functional squads, setting standards, reviewing code and turning fuzzy requirements into a clear, prioritized roadmap.",
...
// "How I work" — principles drawn from the real bio/approach (no invented claims).
export const principles = [
  {
    title: "Readable over clever",
    desc: "Code that people can actually maintain — clear naming, sensible abstractions, and no over-engineering for problems I don't have yet.",
  },
  {
    title: "Conservative & auditable",
    desc: "For systems where mistakes cost money, I keep the logic explainable and traceable — never a black box you just have to trust.",
  },
  {
    title: "Own it end-to-end",
    desc: "I take features from database schema to deployed UI, then keep them fast, observable and easy to change after they ship.",
  },
  {
    title: "AI in the loop",
    desc: "I build Claude & Claude Code into how I design, review and test — faster delivery without dropping engineering rigor.",
  },
];
...
export const experience = [
  ...
  },
  {
    ...
    desc: "Built an admin platform for an FMCG brand and a loyalty mini-app for a pharma brand — UI components, AWS integrations and backend performance work.",
  ...
  },
  {
    ...
    desc: "Built payment integrations (major Vietnamese banks), Messenger and Google Business integrations on a high-throughput service layer.",
...
export const projects = [
  {
    ...
    desc: "Turns in-store camera & IoT feeds into shopper analytics — primary engineer across an 8-service TypeScript monorepo with a real-time image-ingest pipeline.",
  ...
  },
  {
    ...
    desc: "Real-time commodities trading app built end-to-end — handling high-frequency data with Kafka and Redis, from order management through to the mobile client.",
  ...
  },
  {
    ...
    company: "— E-commerce",
    desc: "Admin platform for an FMCG brand — UI components, AWS integrations and backend performance work, from data model to deployment.",
    tags: ["NestJS", "React.js", "AWS", "PostgreSQL"],
  ...
  },
  {
    ...
    company: "— Social",
    desc: "Social media management platform with bank payment integrations (major Vietnamese banks) and real-time Messenger integration.",
    tags: ["Express.js", "MySQL", "MongoDB"],
    badges: [{ t: "● live", cls: "live" }, { t: "team", cls: "team" }],
    live: "",
    code: "",
