...
export const profile = {
  ...
  brandPost: "HQ",
  mark: "V",
  kicker: "✦ Full-Stack Engineer · Hà Nội, VN",
...
export const education = {
  ...
  school: "Advanced Program · VNU University of Science, Hanoi",
};
...
export const featured = {
  ...
  desc: "Retail computer-vision platform turning in-store camera & IoT feeds into shopper analytics — footfall, dwell, conversion and shelf availability. Primary engineer across an 8-service TypeScript monorepo with a real-time image-ingest pipeline.",
  terminal: [
    [["c", "$ "], ["g", "platform"], ["", " deploy --prod"]],
    [["c", "› "], ["", "building "], ["y", "8 services"], ["", " … "], ["g", "ok"]],
    [["c", "› "], ["", "ingest "], ["y", "ffmpeg → webp"], ["", " … "], ["g", "ok"]],
    [["c", "› "], ["", "health check … "], ["g", "200"]],
    [["g", "✓ "], ["", "live · 0 downtime"]],
  ],
  stats: [
    { v: "8", l: "services" },
  ...
  tags: ["TypeScript", "React 19", "Express 5", "MongoDB", "BunnyCDN"],
};
...
export const projects = [
  {
    ...
    name: "Clean-Energy Fintech",
    company: "— Fintech",
    desc: "Led delivery for an Australian clean-energy fintech — vendor webhooks and open-banking income-detection with retry mechanisms, on a Next.js + NestJS + AWS stack.",
...
export const contactInfo = [
  { icon: "phone", k: "Phone", v: "+84 83536 6950", href: "tel:+84835366950" },
...
export const navLinks = [
  ...
  { n: "04", id: "stack", label: "Stack" },
  { n: "05", id: "work", label: "Work" },
